...
- [tend, the workspace tree](tend-the-workspace-tree.md) — `~/tend` since 2026-08-24, a separate repository because the enforcement boundary must live outside a session's write access; sessions first; 2 of 10 audit pieces at the first commit and 6 by the end of day one; Henri decides whether to keep it
