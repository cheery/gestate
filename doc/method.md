...
| [`fixme.md`](../fixme.md) + `fixme/` | 230 entries, 182 resolved, one file each | where the implementation disagrees with the specs |
...
deleted, so the 48 open ones are visible on purpose. And the
