...
| [`board/README.md`](../board/README.md) | 648 | how a task is worked — written for sessions |
| [`spec/`](../spec/) | ~18,000 | how each part is designed, and what it cost |
| [`fixme.md`](../fixme.md) | 216 entries, 171 resolved | where the implementation disagrees with the specs |
