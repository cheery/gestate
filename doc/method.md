...
| [`board/README.md`](../board/README.md) | 659 | how a task is worked — written for sessions |
| [`spec/`](../spec/) | ~18,000 | how each part is designed, and what it cost |
| [`fixme.md`](../fixme.md) | 226 entries, 181 resolved | where the implementation disagrees with the specs |
