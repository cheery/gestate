...
| [`board/README.md`](../board/README.md) | 663 | how a task is worked — written for sessions |
| [`spec/`](../spec/) | ~18,000 | how each part is designed, and what it cost |
| [`fixme.md`](../fixme.md) + `fixme/` | 230 entries, 183 resolved, one file each | where the implementation disagrees with the specs |
