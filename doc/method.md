...
| [`board/README.md`](../board/README.md) | 652 | how a task is worked — written for sessions |
| [`spec/`](../spec/) | ~18,000 | how each part is designed, and what it cost |
| [`fixme.md`](../fixme.md) | 210 entries, 167 resolved | where the implementation disagrees with the specs |
...
deleted, so the 43 open ones are visible on purpose. And the
