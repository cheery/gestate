...
| [`board/README.md`](../board/README.md) | 650 | how a task is worked — written for sessions |
| [`spec/`](../spec/) | ~18,000 | how each part is designed, and what it cost |
| [`fixme.md`](../fixme.md) | 221 entries, 176 resolved | where the implementation disagrees with the specs |
...
deleted, so the 45 open ones are visible on purpose. And the
