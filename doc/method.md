...
| [`fixme.md`](../fixme.md) | 222 entries, 176 resolved | where the implementation disagrees with the specs |
...
deleted, so the 46 open ones are visible on purpose. And the
