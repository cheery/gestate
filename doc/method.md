...
| | lines | who it is for |
|---|---|---|
| [`README.md`](../README.md) | 261 | you, if you want to hear it |
...
| [`board/README.md`](../board/README.md) | 612 | how a task is worked — written for sessions |
| [`spec/`](../spec/) | ~16,000 | how each part is designed, and what it cost |
| [`fixme.md`](../fixme.md) | 190 entries, 159 resolved | where the implementation disagrees with the specs |
...
deleted, so the 31 open ones are visible on purpose. And the
