...
| [`board/README.md`](../board/README.md) | 673 | how a task is worked — written for sessions |
| [`spec/`](../spec/) | ~19,000 | how each part is designed, and what it cost |
| [`fixme.md`](../fixme.md) + `fixme/` | 241 entries, 192 resolved, one file each | where the implementation disagrees with the specs |
