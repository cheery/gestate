...
| [`board/README.md`](../board/README.md) | 644 | how a task is worked — written for sessions |
| [`spec/`](../spec/) | ~17,000 | how each part is designed, and what it cost |
| [`fixme.md`](../fixme.md) | 209 entries, 167 resolved | where the implementation disagrees with the specs |
...
deleted, so the 42 open ones are visible on purpose. And the
