...
Twenty structural checks run at every commit, through a git hook, in
...
| [`fixme.md`](../fixme.md) + `fixme/` | 227 entries, 180 resolved, one file each | where the implementation disagrees with the specs |
