...
fn main() {
    ...
    let mut v = View { top: 0, left: 0, w: 1000, h: 700, gutter: true, aside: 0, piano: 0, focused: false, scale: 1, boxes: vec![], foot_rows: 1, warning: String::new(), plus_hidden: false, hint: false };
