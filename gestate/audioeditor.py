...
#:
#: The corpus, 2026-08-17 (`card:button.md` has the table): the starter
...
#: (`card:gemba.md`).  Arriving at `gestate/gemba.py` and being
...
#: *different* control now stands (`card:button.md`, `fixme.md` F150).
