...
Of 229 entries, **182 are resolved**.  (Those two numbers are checked by `test_citations.py`, because the ledger's whole discipline is that a
...
- **7. Found while building the front end (2026-08-03)** — F50–F229 and `fixme/D3-D4.md`
